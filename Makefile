...
lint-py:  ## lint python with ruff
	python -m ruff check sphinx_fuma
	python -m ruff format --check sphinx_fuma
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix sphinx_fuma
	python -m ruff format sphinx_fuma
...
test:  ## run python tests
	python -m pytest -v sphinx_fuma/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v sphinx_fuma/tests --cov=sphinx_fuma --cov-report term-missing --cov-report xml
